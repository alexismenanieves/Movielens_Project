...
&nbsp;  
In figure 6 we see that the year 1996 has the highest median number of ratings. We also see that movies from 

$\sum_{k=1}^K x_{u,i} \beta_k + \varepsilon_{u,i}$, with $x^k_{u,i} = 1$ if $g_{u,i}$ is genre $k$.
